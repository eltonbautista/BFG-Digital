  ...
  return (
    <section className="grid justify-items-center mb-12">
      <div className="h-screen w-full">
        ...
        {/* <div className="grid gap-4 max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        {/* <div className="group absolute top-full left-1/2 -mt-56 hidden w-full max-w-4xl -translate-x-1/2 shadow-lg duration-300 md:block hover:translate-y-3">
          <div className="absolute inset-0 z-10 flex cursor-pointer items-center justify-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="group-hover:scale-110 group-hover:shadow-lg h-24 w-24 rounded-full border p-6 duration-300"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
            ...
            <div className="grid lg:flex max-w-4xl">
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row sm:space-x-4 sm:px-0">
                  ...
                  {/* <button className="mt-4 flex items-center rounded-lg border-2 border-blue-600 px-6 py-2 font-medium text-blue-600 transition hover:translate-y-1 hover:bg-white">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a
                    href="/"
                    aria-label=""
                    className="group inline-flex items-center font-semibold pt-3 md:mt-1 hover:text-accent"
                  >
                    Watch how it works
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
