...
export default function Navbar({ setTheme }) {
  ...
  return (
    <header className="grid justify-items-center">
      <details className="group transition-all duration-150 h-10 open:h-40 overflow-hidden w-full md:hidden text-base-content">
        ...
        <nav className="mt-1.5 ml-8 flex flex-col transition-all duration-500 z-50">
          <a
            href=""
            className="flex items-center justify-end rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700"
          >
